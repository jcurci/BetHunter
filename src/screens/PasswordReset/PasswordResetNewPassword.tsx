...
const PasswordResetNewPassword: React.FC = () => {
  ...
  const route = useRoute<RNRouteProp<RootStackParamList, "PasswordResetNewPassword">>();
  const { method, value, code } = route.params;
        ...
        <View style={styles.content}>
          <View style={styles.header}>
            ...
            <Text style={styles.title}>
              <Text style={styles.titleBold}>Cadastre uma</Text>
              {"\n"}
              <Text style={styles.titleBold}>nova senha!</Text>
            </Text>
          </View>
